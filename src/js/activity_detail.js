// 更改阅读数量
function act_dea_updatenum(id, num) {
    ...
    getPHP("src/php/query.php?sql=" + sql).then(function(php) {
        ...
        for (var i = 0; i < obj.length; i++) {
            ...
            <div class="act_content">
                <img src="./src/img/activity/${obj[i].img}" alt="">
                <div class="act_text">
                ${obj[i].intro}
                </div>
            </div>
